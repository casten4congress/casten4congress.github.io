...
dem_candidates = ["Leslie Coolidge","Geoffrey Petzel","Maureen E. Yates"]
...
for county in counties:
	...
	for row in reader:
		...
		if county=='Kane': precinct_name = precinct_name[:2]+"00"+precinct_name[2:]
...
output_filename = "2012PrimaryCongressional.csv"
output_f = open(output_filename, "w")
output_w = csv.DictWriter(output_f, fieldnames=["County","Precinct","Leslie Coolidge","Geoffrey Petzel","Maureen E. Yates",'Peter J. Roskam'])
...
for county in counties:
	for precinct in precincts[county]:
		r = {'County': county, 'Precinct': precinct, 'Peter J. Roskam': precincts[county][precinct]['Peter J. Roskam']}
		for cand in dem_candidates: r[cand] = precincts[county][precinct][cand]
		output_w.writerow(r)
